package com.fabscorp.coroutineusecasesonandroid.base

import android.os.Parcelable
import androidx.appcompat.app.AppCompatActivity
import com.fabscorp.coroutineusecasesonandroid.usecases.coroutines.usecase1.PerformSingleNetworkRequestActivity
import com.fabscorp.coroutineusecasesonandroid.usecases.coroutines.usecase10.CalculationInBackgroundActivity
import com.fabscorp.coroutineusecasesonandroid.usecases.coroutines.usecase11.CooperativeCancellationActivity
import com.fabscorp.coroutineusecasesonandroid.usecases.coroutines.usecase12.CalculationInSeveralCoroutinesActivity
import com.fabscorp.coroutineusecasesonandroid.usecases.coroutines.usecase13.ExceptionHandlingActivity
import com.fabscorp.coroutineusecasesonandroid.usecases.coroutines.usecase14.ContinueCoroutineWhenUserLeavesScreenActivity
import com.fabscorp.coroutineusecasesonandroid.usecases.coroutines.usecase15.WorkManagerActivity
import com.fabscorp.coroutineusecasesonandroid.usecases.coroutines.usecase16.PerformanceAnalysisActivity
import com.fabscorp.coroutineusecasesonandroid.usecases.coroutines.usecase17.PerformCalculationOnMainThreadActivity
import com.fabscorp.coroutineusecasesonandroid.usecases.coroutines.usecase2.Perform2SequentialNetworkRequestsActivity
import com.fabscorp.coroutineusecasesonandroid.usecases.coroutines.usecase2.callbacks.SequentialNetworkRequestsCallbacksActivity
import com.fabscorp.coroutineusecasesonandroid.usecases.coroutines.usecase2.rx.SequentialNetworkRequestsRxActivity
import com.fabscorp.coroutineusecasesonandroid.usecases.coroutines.usecase3.PerformNetworkRequestsConcurrentlyActivity
import com.fabscorp.coroutineusecasesonandroid.usecases.coroutines.usecase4.VariableAmountOfNetworkRequestsActivity
import com.fabscorp.coroutineusecasesonandroid.usecases.coroutines.usecase5.NetworkRequestWithTimeoutActivity
import com.fabscorp.coroutineusecasesonandroid.usecases.coroutines.usecase6.RetryNetworkRequestActivity
import com.fabscorp.coroutineusecasesonandroid.usecases.coroutines.usecase7.TimeoutAndRetryActivity
import com.fabscorp.coroutineusecasesonandroid.usecases.coroutines.usecase7.callbacks.TimeoutAndRetryCallbackActivity
import com.fabscorp.coroutineusecasesonandroid.usecases.coroutines.usecase7.rx.TimeoutAndRetryRxActivity
import com.fabscorp.coroutineusecasesonandroid.usecases.coroutines.usecase8.RoomAndCoroutinesActivity
import com.fabscorp.coroutineusecasesonandroid.usecases.coroutines.usecase9.DebuggingCoroutinesActivity
import com.fabscorp.coroutineusecasesonandroid.usecases.flow.usecase1.FlowUseCase1Activity
import com.fabscorp.coroutineusecasesonandroid.usecases.flow.usecase2.FlowUseCase2Activity
import com.fabscorp.coroutineusecasesonandroid.usecases.flow.usecase3.FlowUseCase3Activity
import com.fabscorp.coroutineusecasesonandroid.usecases.flow.usecase4.FlowUseCase4Activity
